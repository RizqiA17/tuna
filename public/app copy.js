...
import { GameUIRenderer } from './js/ui/GameUIRenderer.js';
import { GameEventHandler } from './js/events/GameEventHandler.js';
...
class TunaAdventureGame {
  ...
  initWebSocket() {
    ...
    // Game progression is now fully self-controlled by teams
    // Removed: game-start-command, next-scenario-command, end-game-command
  ...
  saveTimerState() {
    // Timer functionality removed - game is self-paced
  }
